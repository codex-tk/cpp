...
TEST( tmp , type_list ) {
    codex::sample::sample_tuple< int , double , char > tuple;
    codex::sample::sample_tuple_get< 0 > (tuple) = 1;
    codex::sample::sample_tuple_get< 1 > (tuple) = 1.1;
    codex::sample::sample_tuple_get< 2 > (tuple) = 'c';

    ASSERT_EQ( codex::sample::sample_tuple_get< 0 > (tuple) , 1  );
    ASSERT_EQ( codex::sample::sample_tuple_get< 1 > (tuple) , 1.1  );
