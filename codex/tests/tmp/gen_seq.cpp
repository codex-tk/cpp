...
TEST( gen_seq_test , usage ) {
    std::cout << codex::pretty_type_name( gen_seq<0>::type() ) << std::endl;
    std::cout << codex::pretty_type_name( gen_seq<1>::type() ) << std::endl;
/*
    struct gen_seq : concat<
    ...
    : seq< 0 , 1 + 0 >{};*/
    // gen_seq<2> - > seq< 0 , 1 >
    std::cout << codex::pretty_type_name( gen_seq<2>::type() ) << std::endl;
/*
    struct gen_seq : concat<
    ...
    // seq< 0 , 1  , 2>
    std::cout << codex::pretty_type_name( gen_seq<3>::type() ) << std::endl;
    ...
    : seq< 0 , 1 ,  2 + 0 , 2 + 1  >{}; ////sizeof...(I1) == 2
     seq< 0 , 1 , 2 , 3>
    */
    std::cout << "4" <<  codex::pretty_type_name( gen_seq<4>::type() ) << std::endl;
    std::cout << codex::pretty_type_name( gen_seq<5>::type() ) << std::endl;
    std::cout << codex::pretty_type_name( gen_seq<6>::type() ) << std::endl;
    std::cout << codex::pretty_type_name( gen_seq<10>::type()) << std::endl;

    std::cout << codex::pretty_type_name( concat<seq<> , seq<0>>::type()) << std::endl;
}
...
TEST( tmp , rebind ) {
    std::cout << codex::pretty_type_name( rebind< 1 , 2 ,3 >::type{} ) << std::endl;
}
...
TEST( tmp , tuple_element ) {
    ...
    std::cout << codex::pretty_type_name( tup ) << std::endl;

    _eval<  int , char , double , short >::type tup2;
    std::cout << codex::pretty_type_name( tup2 ) << std::endl;
    
    std::cout <<  codex::pretty_type_name(  pop_back<  int , char , void* >{}) << std::endl;
    std::cout <<  codex::pretty_type_name(  pop_back<  int , char , void* >::rebind<dispose>{} ) << std::endl;
    std::cout <<  codex::pretty_type_name(  pop_back<  int , char , void* >::rebind<dispose>::type{} ) << std::endl;
    std::cout <<  codex::pretty_type_name(  pop_back0< int , char , void* >::type{} ) << std::endl;
    std::cout <<  codex::pretty_type_name(  pop_back0< type_list< int , char , void* > >::type{} ) << std::endl;
}