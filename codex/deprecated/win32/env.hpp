#ifndef __codex_util_env_h__
#define __codex_util_env_h__
...
public:
	...
	static codex::tstring		__stdcall process_name( void );
	static codex::tstring		__stdcall process_directory( void );
	static codex::tstring		__stdcall current_directory( void );
	static codex::tstring		__stdcall process_path( void );
	static int				__stdcall page_size( void );

	static codex::tstring		__stdcall os_version_string( void );
};
