...
template < typename Head , typename ... Ts >
struct pop_front { using type = type_list< Ts ... >; };
...
template < typename ... Ts > struct type_list{
    template < std::size_t I > using at = typename at< I , type_list< Ts ... > >::type;
    using front = at<0>;
    using back = at< sizeof ... (Ts ) - 1 >;
    template < typename U > using push_front = type_list< U , Ts ... >;
    template < typename U > using push_back = type_list< Ts ... , U >;
    ...
    template < template < typename ... Ts0 > class  U > using rebind = U< Ts ... >;
};
